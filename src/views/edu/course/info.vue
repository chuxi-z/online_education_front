  ...
  <div class="app-container">
    ...
    <el-form label-width="120px">
      ...
      <el-form-item label="分类">
        <el-select @change="getTwoSubject"
      ...
      <el-form-item label="课程封面">
        ...
        <el-upload
          ...
          <img :src="courseInfo.cover" width="400" height="400">
        </el-upload>
      ...
      <el-form-item label="课程价格">
        <el-input-number :min="0" v-model="courseInfo.price" controls-position="right" placeholder="免费课程请设置为0元"/> dollers
      </el-form-item>
